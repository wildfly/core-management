...
public final class XMLLocation implements Location, Comparable<XMLLocation> {
     ...
     */
    public org.jboss.msc.txn.Location toMSCLocation(org.jboss.msc.txn.Location parent, org.jboss.msc.txn.Location.Nesting nestingType) {
        return new org.jboss.msc.txn.Location(fileName, lineNumber, columnNumber, parent, nestingType);
    }
     ...
     * @return the corresponding MSC location
     */
    public org.jboss.msc.txn.Location toMSCLocation() {
        return new org.jboss.msc.txn.Location(fileName, lineNumber, columnNumber);
    }
